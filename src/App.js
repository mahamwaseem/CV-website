...
@media(max-width:900px){
  ...
  .hero{grid-template-columns:1fr;min-height:auto;padding:60px 0 0}
  .hero-left{padding:40px 20px 20px}
  .hero-right{position:relative;width:100%;height:350px;display:flex;align-items:flex-end;justify-content:center;overflow:visible;margin-top:20px}
  .hero-yellow-bg{width:180px;height:260px;bottom:-20px}
  .hero-img-wrap{width:170px;height:260px;border:6px solid rgba(255,255,255,0.2)}
  .hero-badge{font-size:9px;padding:6px 12px;top:15px;right:10px}
